...
//  UberClone
//
//  Created by Halil YAŞ on 1.02.2023.
//
...
class PickupController : UIViewController {
    ...
    func configureUI() {
        ...
        acceptTripButton.anchor(top: pickupLabel.bottomAnchor,left: view.leftAnchor,right: view.rightAnchor,paddingTop: 16,paddingLeft: 32,paddingRight: 32,height: 40)
    }
}
